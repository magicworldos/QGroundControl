...
{
	typedef typename Lhs::Index Index;
	static EIGEN_STRONG_INLINE void run(Index /*row*/, Index /*col*/, const Lhs & /*lhs*/, const Rhs & /*rhs*/,
					    RetScalar &res)
	{
		res = RetScalar(0);
	}
...
struct product_coeff_vectorized_unroller
{
					    ...
					    typename Lhs::PacketScalar &pres)
	{
		...
		pres = padd(pres, pmul(lhs.template packet<Aligned>(row, UnrollingIndex), rhs.template packet<Aligned>(UnrollingIndex,
				       col)));
	}
};
...
struct product_packet_impl<RowMajor, UnrollingIndex, Lhs, Rhs, Packet, LoadMode>
{
	...
	static EIGEN_STRONG_INLINE void run(Index row, Index col, const Lhs &lhs, const Rhs &rhs, Packet &res)
	{
		...
		res =  pmadd(pset1<Packet>(lhs.coeff(row, UnrollingIndex - 1)), rhs.template packet<LoadMode>(UnrollingIndex - 1, col),
			     res);
	}
};
...
struct product_packet_impl<ColMajor, UnrollingIndex, Lhs, Rhs, Packet, LoadMode>
{
	...
	static EIGEN_STRONG_INLINE void run(Index row, Index col, const Lhs &lhs, const Rhs &rhs, Packet &res)
	{
		...
		res =  pmadd(lhs.template packet<LoadMode>(row, UnrollingIndex - 1), pset1<Packet>(rhs.coeff(UnrollingIndex - 1, col)),
			     res);
	}
};
