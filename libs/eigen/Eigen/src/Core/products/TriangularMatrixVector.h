	...
	: public ProductBase<TriangularProduct<Mode, false, Lhs, true, Rhs, false>, Lhs, Rhs >
{
	...
	template<typename Dest> void scaleAndAddTo(Dest &dst, const Scalar &alpha) const
	{
		...
		typedef TriangularProduct < (Mode & (UnitDiag | ZeroDiag)) | ((Mode & Lower) ? Upper : Lower), true,
			Transpose<const Rhs>, false, Transpose<const Lhs>, true > TriangularProductTranspose;
