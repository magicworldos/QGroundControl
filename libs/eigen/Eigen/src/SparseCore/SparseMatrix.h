...
protected:
	...
	inline void reserveInnerVectors(const SizesType &reserveSizes)
	{
		if (isCompressed())
		{
			...
			m_outerIndex[m_outerSize] = m_outerIndex[m_outerSize - 1] + m_innerNonZeros[m_outerSize - 1] + reserveSizes[m_outerSize
						    - 1];
...
template<typename Scalar, int _Options, typename _Index>
template<typename OtherDerived>
EIGEN_DONT_INLINE SparseMatrix<Scalar, _Options, _Index> &SparseMatrix<Scalar, _Options, _Index>::operator=
