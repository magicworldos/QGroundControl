	...
	_airframeTypesModel(new QmlObjectListModel(this))
{
	if (!_typesRegistered)
	{
		...
		qmlRegisterUncreatableType<APMAirframeType>("QGroundControl.Controllers", 1, 0, "APMAirframeType",
				QStringLiteral("Can only reference APMAirframeType"));
	}
...
void APMAirframeComponentController::loadParameters(const QString &paramFile)
{
	...
	connect(downloader, &QGCFileDownload::downloadFinished, this,
		&APMAirframeComponentController::_githubJsonDownloadFinished);
...
void APMAirframeComponentController::_githubJsonDownloadFinished(QString remoteFile, QString localFile)
{
	...
	QGCFileDownload *downloader = new QGCFileDownload(this);
	connect(downloader, &QGCFileDownload::downloadFinished, this,
		&APMAirframeComponentController::_paramFileDownloadFinished);
