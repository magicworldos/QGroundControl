...
void PX4AdvancedFlightModesController::_validateConfiguration(void)
{
	...
	switchParams << "RC_MAP_MODE_SW"  << "RC_MAP_ACRO_SW"  << "RC_MAP_POSCTL_SW" << "RC_MAP_LOITER_SW" << "RC_MAP_RETURN_SW"
		     << "RC_MAP_OFFB_SW";
	...
	thresholdParams << "RC_ASSIST_TH" << "RC_AUTO_TH" << "RC_ACRO_TH" << "RC_POSCTL_TH" << "RC_LOITER_TH" << "RC_RETURN_TH"
			<< "RC_OFFB_TH";
