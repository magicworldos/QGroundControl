...
QList<MAV_TYPE> FirmwarePluginFactory::supportedVehicleTypes(void) const
{
	...
	vehicleTypes << MAV_TYPE_FIXED_WING << MAV_TYPE_QUADROTOR << MAV_TYPE_VTOL_QUADROTOR << MAV_TYPE_GROUND_ROVER <<
		     MAV_TYPE_SUBMARINE;
	return vehicleTypes;
}
...
void FirmwarePlugin::adjustOutgoingMavlinkMessage(Vehicle *vehicle, LinkInterface *outgoingLink,
...
void FirmwarePlugin::guidedModeOrbit(Vehicle * /*vehicle*/, const QGeoCoordinate & /*centerCoord*/, double /*radius*/,
...
const QVariantList &FirmwarePlugin::cameraList(const Vehicle *vehicle)
{
	...
	if (_cameraList.size() == 0)
	{
		...
		metaData = new CameraMetaData(
			tr("Sony NEX-5R 20mm"),  //http://www.sony.co.uk/electronics/interchangeable-lens-cameras/ilce-qx1-body-kit/specifications
		...
		metaData = new CameraMetaData(
			tr("Sony ILCE-QX1"),  //http://www.sony.co.uk/electronics/interchangeable-lens-cameras/ilce-qx1-body-kit/specifications
			23.2,                 //http://www.sony.com/electronics/camera-lenses/sel16f28/specifications
			15.4,
			5456,
			3632,
		...
		metaData = new CameraMetaData(
			tr("Sony a6000 16mm"),    //http://www.sony.co.uk/electronics/interchangeable-lens-cameras/ilce-6000-body-kit#product_details_default
			23.5,
			15.6,
			6000,
			4000,
...
QGCCameraControl *FirmwarePlugin::createCameraControl(const mavlink_camera_information_t *info, Vehicle *vehicle,
