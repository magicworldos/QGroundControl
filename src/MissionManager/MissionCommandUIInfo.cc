...
bool MissionCommandUIInfo::loadJsonInfo(const QJsonObject &jsonObject, bool requireFullObject, QString &errorString)
{
	...
	QStringList allKeys;
	allKeys << _idJsonKey << _rawNameJsonKey << _friendlyNameJsonKey << _descriptionJsonKey << _standaloneCoordinateJsonKey
		<< _specifiesCoordinateJsonKey
		<< _friendlyEditJsonKey << _param1JsonKey << _param2JsonKey << _param3JsonKey << _param4JsonKey << _param5JsonKey <<
		_param6JsonKey << _param7JsonKey
	...
	types << QJsonValue::Double << QJsonValue::String << QJsonValue::String << QJsonValue::String << QJsonValue::Bool <<
	      ...
	      << QJsonValue::Object << QJsonValue::Object << QJsonValue::Object << QJsonValue::Object << QJsonValue::Object <<
	...
	for (int i = 1; i <= 7; i++)
	{
		...
		if (jsonObject.contains(paramKey))
		{
			...
			allParamKeys << _defaultJsonKey << _decimalPlacesJsonKey << _enumStringsJsonKey << _enumValuesJsonKey << _labelJsonKey
				     << _unitsJsonKey << _nanUnchangedJsonKey;
			...
			// Validate key types
			QList<QJsonValue::Type> types;
			types << QJsonValue::Null <<  QJsonValue::Double << QJsonValue::String << QJsonValue::String << QJsonValue::String <<
			      QJsonValue::String << QJsonValue::Bool;
			...
			{
				internalError = QString("enum strings/values count mismatch: %1, %2").arg(paramInfo->_enumStrings.count()).arg(
							paramInfo->_enumValues.count());
				errorString = _loadErrorString(internalError);
				return false;
			}
