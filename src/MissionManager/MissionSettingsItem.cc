	...
	, _dirty(false)
{
	...
	{
		_metaDataMap = FactMetaData::createMapFromJsonFile(QStringLiteral(":/json/MissionSettings.FactMetaData.json"),
				NULL /* metaDataParent */);
	}
	...
	connect(this,               &MissionSettingsItem::missionEndRTLChanged,             this,
		&MissionSettingsItem::_setDirtyAndUpdateLastSequenceNumber);
	...
	connect(this,               &MissionSettingsItem::terrainAltitudeChanged,           this,
		&MissionSettingsItem::_setHomeAltFromTerrain);

	connect(&_plannedHomePositionAltitudeFact,  &Fact::valueChanged,                    this,
...
bool MissionSettingsItem::scanForMissionSettings(QmlObjectListModel *visualItems, int scanIndex)
{
	...
	qCDebug(MissionSettingsComplexItemLog) << "MissionSettingsItem::scanForMissionSettings count:scanIndex" <<
