	...
	, _flightSpeedFact(0, _flightSpeedName,   FactMetaData::valueTypeDouble)
{
	...
	{
		_metaDataMap = FactMetaData::createMapFromJsonFile(QStringLiteral(":/json/SpeedSection.FactMetaData.json"),
				NULL /* metaDataParent */);
	}
	...
	connect(this,               &SpeedSection::specifyFlightSpeedChanged,   this,
		&SpeedSection::_updateSpecifiedFlightSpeed);
	connect(&_flightSpeedFact,  &Fact::valueChanged,                        this,
		&SpeedSection::_updateSpecifiedFlightSpeed);
}
