...
void SpeedSectionTest::_testAppendSectionItems(void)
{
	...
	QCOMPARE(seqNum, 1);
	MissionItem expectedSpeedItem(0, MAV_CMD_DO_CHANGE_SPEED, MAV_FRAME_MISSION, _offlineVehicle->multiRotor() ? 1 : 0,
...
void SpeedSectionTest::_testScanForSection(void)
{
	...
	MissionItem validSpeedItem(0, MAV_CMD_DO_CHANGE_SPEED, MAV_FRAME_MISSION, _offlineVehicle->multiRotor() ? 1 : 0,
