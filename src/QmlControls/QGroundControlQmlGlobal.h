...
public:
	...
	Q_PROPERTY(qreal zOrderTopMost              READ zOrderTopMost
		   CONSTANT) ///< z order for top most items, toolbar, main window sub view
	...
	Q_PROPERTY(int      mavlinkSystemID         READ mavlinkSystemID            WRITE setMavlinkSystemID            NOTIFY
	...
	Q_PROPERTY(double         flightMapZoom         READ flightMapZoom          WRITE setFlightMapZoom              NOTIFY
