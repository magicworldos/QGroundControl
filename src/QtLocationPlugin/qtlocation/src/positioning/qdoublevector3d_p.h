...
public:
	...
	double distanceToPlane(const QDoubleVector3D &plane1, const QDoubleVector3D &plane2,
...
Q_DECL_CONSTEXPR inline QDoubleVector3D::QDoubleVector3D(double xpos, double ypos, double zpos) : xp(xpos), yp(ypos),
	zp(zpos) {}
