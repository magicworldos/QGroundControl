...
Fact *UnitsSettings::areaUnits(void)
{
	if (!_areaUnitsFact)
	{
		...
		enumValues << QVariant::fromValue((uint32_t)AreaUnitsSquareFeet) << QVariant::fromValue((
					uint32_t)AreaUnitsSquareMeters) << QVariant::fromValue((uint32_t)AreaUnitsSquareKilometers) << QVariant::fromValue((
							uint32_t)AreaUnitsHectares) << QVariant::fromValue((uint32_t)AreaUnitsAcres) << QVariant::fromValue((
									uint32_t)AreaUnitsSquareMiles);
...
Fact *UnitsSettings::speedUnits(void)
{
	if (!_speedUnitsFact)
	{
		...
		enumValues << QVariant::fromValue((uint32_t)SpeedUnitsFeetPerSecond) << QVariant::fromValue((
					uint32_t)SpeedUnitsMetersPerSecond) << QVariant::fromValue((uint32_t)SpeedUnitsMilesPerHour) << QVariant::fromValue((
							uint32_t)SpeedUnitsKilometersPerHour) << QVariant::fromValue((uint32_t)SpeedUnitsKnots);
...
Fact *UnitsSettings::temperatureUnits(void)
{
	if (!_temperatureUnitsFact)
	{
		...
		enumValues << QVariant::fromValue((uint32_t)TemperatureUnitsCelsius) << QVariant::fromValue((
					uint32_t)TemperatureUnitsFarenheit);
