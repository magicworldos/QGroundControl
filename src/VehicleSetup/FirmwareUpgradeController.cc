	...
	, _image(NULL)
{
	...
	connect(_threadController, &PX4FirmwareUpgradeThreadController::foundBootloader,        this,
		&FirmwareUpgradeController::_foundBootloader);
	connect(_threadController, &PX4FirmwareUpgradeThreadController::bootloaderSyncFailed,   this,
		&FirmwareUpgradeController::_bootloaderSyncFailed);
	connect(_threadController, &PX4FirmwareUpgradeThreadController::error,                  this,
		&FirmwareUpgradeController::_error);
	...
	connect(_threadController, &PX4FirmwareUpgradeThreadController::status,                 this,
		&FirmwareUpgradeController::_status);
...
void FirmwareUpgradeController::_initFirmwareHash()
{
	...
	for (int i = 0; i < size; i++)
	{
		...
		_rgPX4FMUV5Firmware.insert(FirmwareIdentifier(element.stackType, element.firmwareType, element.vehicleType),
					   element.url);
	}
	...
	for (int i = 0; i < size; i++)
	{
		...
		_rgPX4FMUV4PROFirmware.insert(FirmwareIdentifier(element.stackType, element.firmwareType, element.vehicleType),
					      element.url);
	}
	...
	for (int i = 0; i < size; i++)
	{
		...
		_rgPX4FMUV4Firmware.insert(FirmwareIdentifier(element.stackType, element.firmwareType, element.vehicleType),
					   element.url);
	}
	...
	for (int i = 0; i < size; i++)
	{
		...
		_rgPX4FMUV3Firmware.insert(FirmwareIdentifier(element.stackType, element.firmwareType, element.vehicleType),
					   element.url);
	}
	...
	for (int i = 0; i < size; i++)
	{
		...
		_rgPX4FMUV2Firmware.insert(FirmwareIdentifier(element.stackType, element.firmwareType, element.vehicleType),
					   element.url);
	}
	...
	for (int i = 0; i < size; i++)
	{
		...
		_rgAeroCoreFirmware.insert(FirmwareIdentifier(element.stackType, element.firmwareType, element.vehicleType),
					   element.url);
	}
	...
	for (int i = 0; i < size; i++)
	{
		...
		_rgAUAVX2_1Firmware.insert(FirmwareIdentifier(element.stackType, element.firmwareType, element.vehicleType),
					   element.url);
	}
	...
	for (int i = 0; i < size; i++)
	{
		...
		_rgMindPXFMUV2Firmware.insert(FirmwareIdentifier(element.stackType, element.firmwareType, element.vehicleType),
					      element.url);
	}
	...
	for (int i = 0; i < size; i++)
	{
		...
		_rgCrazyflie2Firmware.insert(FirmwareIdentifier(element.stackType, element.firmwareType, element.vehicleType),
					     element.url);
	}
	...
	for (int i = 0; i < size; i++)
	{
		...
		_rgPX4FLowFirmware.insert(FirmwareIdentifier(element.stackType, element.firmwareType, element.vehicleType),
					  element.url);
	}
	...
	for (int i = 0; i < size; i++)
	{
		...
		_rg3DRRadioFirmware.insert(FirmwareIdentifier(element.stackType, element.firmwareType, element.vehicleType),
					   element.url);
	}
...
void FirmwareUpgradeController::_getFirmwareFile(FirmwareIdentifier firmwareId)
{
	...
	{
		_firmwareFilename = QGCQFileDialog::getOpenFileName(
					    NULL,                                                                // Parent to main window
...
void FirmwareUpgradeController::_firmwareDownloadFinished(QString remoteFile, QString localFile)
{
	...
	{
		_errorCancel(tr("Image size of %1 is too large for board flash size %2").arg(image->imageSize()).arg(
...
void FirmwareUpgradeController::_apmVersionDownloadFinished(QString remoteFile, QString localFile)
{
	...
	foreach (FirmwareIdentifier firmwareId, prgFirmware->keys())
	{
		...
		{
			qCDebug(FirmwareUpgradeLog) << "Adding version to map, version:firwmareType:vehicleType" << version <<
						    firmwareId.firmwareType << firmwareId.firmwareVehicleType;
...
{
	QGCFileDownload *downloader = new QGCFileDownload(this);
	connect(downloader, &QGCFileDownload::downloadFinished, this,
		&FirmwareUpgradeController::_px4ReleasesGithubDownloadFinished);
...
void FirmwareUpgradeController::_px4ReleasesGithubDownloadFinished(QString remoteFile, QString localFile)
{
	...
	{
		qCWarning(FirmwareUpgradeLog) <<  "Unable to open px4 releases json document" << localFile <<
