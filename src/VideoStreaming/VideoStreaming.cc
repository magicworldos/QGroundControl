...
void initializeVideoStreaming(int &argc, char *argv[], char *logpath, char *debuglevel)
{
	...
	qgcputenv("GIO_EXTRA_MODULES",            currentDir,
	...
	qmlRegisterUncreatableType<VideoSurface>("QGroundControl.QgcQtGStreamer", 1, 0, "VideoSurface",
			QLatin1String("VideoSurface from QML is not supported"));
}
