...
void MockLinkMissionItemHandler::_handleMissionCount(const mavlink_message_t &msg)
{
	...
	qCDebug(MockLinkMissionItemHandlerLog) << "_handleMissionCount write sequence _writeSequenceCount:" <<
					       _writeSequenceCount;
...
void MockLinkMissionItemHandler::_requestNextMissionItem(int sequenceNumber)
{
	...
	else
	{
		...
		{
			qCWarning(MockLinkMissionItemHandlerLog) <<
					"_requestNextMissionItem requested seqeuence number > write count sequenceNumber::_writeSequenceCount" << sequenceNumber
					<< _writeSequenceCount;
			return;
		}
