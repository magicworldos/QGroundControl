	...
	, _ui(new Ui::MultiVehicleDockWidget)
{
	...
	connect(qgcApp()->toolbox()->multiVehicleManager(), &MultiVehicleManager::activeVehicleChanged, this,
		&MultiVehicleDockWidget::_activeVehicleChanged);
	connect(qgcApp()->toolbox()->multiVehicleManager(), &MultiVehicleManager::vehicleAdded, this,
		&MultiVehicleDockWidget::_vehicleAdded);
	connect(qgcApp()->toolbox()->multiVehicleManager(), &MultiVehicleManager::vehicleRemoved, this,
		&MultiVehicleDockWidget::_vehicleRemoved);
}
