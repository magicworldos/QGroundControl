...
const char *QGCHilFlightGearConfiguration::_defaultOptions =
...

{
	...
	bool success = connect(&_resetOptionsAction, &QAction::triggered, this,
			       &QGCHilFlightGearConfiguration::_setDefaultOptions);
	Q_ASSERT(success);
