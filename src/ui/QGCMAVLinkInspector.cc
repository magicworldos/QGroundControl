...
QGCMAVLinkInspector::QGCMAVLinkInspector(const QString &title, QAction *action, MAVLinkProtocol *protocol,
		QWidget *parent) :
	...
	ui(new Ui::QGCMAVLinkInspector)
{
	...
	connect(qgcApp()->toolbox()->multiVehicleManager(), &MultiVehicleManager::vehicleAdded, this,
		&QGCMAVLinkInspector::_vehicleAdded);
...
void QGCMAVLinkInspector::updateField(mavlink_message_t *msg, const mavlink_message_info_t *msgInfo, int fieldid,
